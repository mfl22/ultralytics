...
class Model(nn.Module):
    ...
    def get_vis_dataloader(
        self,
        trainer=None,
        **kwargs,
    ):
        """
        modified train() method; create trainer / dataloader and return it for
        ...
        # trainset, _ = self.trainer.get_dataset()

        # print(trainset)

        # train_loader = self.trainer.get_dataloader(trainset)
